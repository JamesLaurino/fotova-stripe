...
public class StripeService {
    ...
    public String buildSuccessHtml() {
        ...
        <!DOCTYPE html>
                    ...
                    <meta http-equiv="refresh" content="5;url=http://localhost:4200/success">
                    <style>
                        body {
                    ...
                    <div class="card">
                        ...
                        <a href="http://localhost:4200/success">
    ...
    public String buildCancelHtml() {
        ...
        <meta http-equiv="refresh" content="5;url=http://localhost:4200/cart">
        <style>
            body {
                font-family: -apple-system, BlinkMacSystemFont, sans-serif;
                background: #f6f9fc;
