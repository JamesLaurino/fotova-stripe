...
@Service
@Profile("acc")
public class StripeHtmlAccService implements StripeHtmlService {
    public String buildSuccessHtml() {
        ...
        <!DOCTYPE html>
                    ...
                    <meta http-equiv="refresh" content="5;url=http://10.0.0.1/success">
                    <style>
                        body {
                    ...
                    <script>
                        ...
                        const interval = setInterval(() => {
                            ...
                            if(seconds <= 0) {
                                ...
                                window.location.href = "http://10.0.0.1/success";
                            }
                        }, 1000);
                    </script>
    ...
    public String buildCancelHtml() {
        ...
        <meta http-equiv="refresh" content="5;url=http://10.0.0.1/cart">
        <style>
            body {
                font-family: -apple-system, BlinkMacSystemFont, sans-serif;
                background: #f6f9fc;
        ...
        <script>
            ...
            const interval = setInterval(() => {
                ...
                if(seconds <= 0) {
                    clearInterval(interval);
                    window.location.href = "http://10.0.0.1/cart";
                }
            }, 1000);
        </script>
