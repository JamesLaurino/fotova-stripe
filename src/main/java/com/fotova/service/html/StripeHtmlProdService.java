...
@Service
@Profile("prod")
public class StripeHtmlProdService implements StripeHtmlService {
    public String buildSuccessHtml() {
        ...
        <!DOCTYPE html>
                    ...
                    <meta http-equiv="refresh" content="5;url=https://82.29.172.74/success">
                    <style>
                        body {
                    ...
                    <div class="card">
                        ...
                        <a href="https://82.29.172.74/success">
                    ...
                    <script>
                        ...
                        const interval = setInterval(() => {
                            ...
                            if(seconds <= 0) {
                                ...
                                window.location.href = "https://82.29.172.74/success";
                            }
                        }, 1000);
                    </script>
    ...
    public String buildCancelHtml() {
        ...
        <meta http-equiv="refresh" content="5;url=https://82.29.172.74/cart">
        <style>
            body {
                font-family: -apple-system, BlinkMacSystemFont, sans-serif;
                background: #f6f9fc;
        ...
        <script>
            ...
            const interval = setInterval(() => {
                ...
                if(seconds <= 0) {
                    clearInterval(interval);
                    window.location.href = "https://82.29.172.74/cart";
                }
            }, 1000);
        </script>
